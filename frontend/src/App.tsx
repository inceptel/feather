  ...
  return (
    <div
                  ...
                  <div style={{ display: 'flex', 'align-items': 'flex-start', gap: '8px' }}>
                    <span
                      ...
                      style={{
                        ...
                        height: '6px',
                        'border-radius': '50%',
                        background: s.isActive ? '#4aba6a' : 'transparent',
                        'flex-shrink': '0',
                        'margin-top': '5px',
                      }}
                    />
      ...
      <div aria-hidden={sidebar() ? 'true' : undefined} style={{ flex: '1', display: 'flex', 'flex-direction': 'column', 'min-width': '0', height: '100%', 'pointer-events': sidebar() ? 'none' : 'auto', overflow: 'hidden' }}>
        {/* Header */}
        <div style={{ padding: 'max(8px, env(safe-area-inset-top, 0px)) max(16px, env(safe-area-inset-right, 0px)) 8px calc(56px + env(safe-area-inset-left, 0px))', 'border-bottom': '1px solid #1e1e1e', display: 'flex', 'align-items': 'flex-start', gap: '6px', 'min-height': '48px', 'flex-shrink': '0' }}>
