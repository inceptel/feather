...
//   FEATHER_OMP_MODEL     (default anthropic/claude-opus-5-5; '' opts out, using omp's own default)
//   FEATHER_OMP_THINKING  (default medium; e.g. high or xhigh)

const OMP_THINKING_LEVELS = new Set(['off', 'minimal', 'low', 'medium', 'high', 'xhigh', 'max', 'auto'])
const DEFAULT_OMP_MODEL = 'anthropic/claude-opus-5-5'
const DEFAULT_OMP_THINKING = 'medium'
