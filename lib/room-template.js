...
export function houseRoomFiles({ now = new Date() } = {}) {
  ...
  const cardStyle = [
    ...
    '- **Summary**: two to four short sentences, under 400 characters. First the answer. Then the one reason that matters most. Then what happens next, or what he can do about it.',
    '- **Detail** (optional): up to five more short sentences for the reader who wants the reasoning. Same rules.',
