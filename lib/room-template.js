...
// standard resident, and describes the four Ralph residents that the server
// registers: caretaker (wiki), updater (decides what reaches the user),
// marketer (renders the card and its image), and replyguy (answers the
// user's comments under the cards).
