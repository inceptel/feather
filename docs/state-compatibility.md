...
|---|---|---|---|---|---|
| `boxes.json` | Instance state | Object keyed by box id | `{}` | Read-only in both releases; no envelope added | `0600` |
...
compatible by retaining their exact v0 root types and mutation shapes; the Zak
